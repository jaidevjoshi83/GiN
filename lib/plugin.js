...
const base_exports = __importStar(require("@genepattern/nbtools"));
const uioutput_exports = __importStar(require("@genepattern/nbtools"));
const uibuilder_exports = __importStar(require("@genepattern/nbtools"));
const galaxyuioutput_exports = __importStar(require("./widget"));
