...
# -*- coding: utf-8 -*-
#
# galaxylab documentation build configuration file
#
...
_version_py = os.path.join(repo, 'galaxylab', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'galaxylabdoc'
...
latex_documents = [
    (master_doc, 'galaxylab.tex', 'galaxylab Documentation',
     'Jayadev Joshi', 'manual'),
]
