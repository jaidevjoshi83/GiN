class GalaxyEventManager(object):
    _instance = None                             # EventManager singleton

    @staticmethod
    def instance():
        if GalaxyEventManager._instance is None:
            GalaxyEventManager._instance = GalaxyEventManager()
        return GalaxyEventManager._instance
