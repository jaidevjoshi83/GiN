import nbtools
from nbtools import BaseWidget
...
class GalaxyBaseWidgetModel(BaseWidget):
    _model_name = Unicode('GalaxyBaseWidgetModel').tag(sync=True)
    _model_module = Unicode(module_name).tag(sync=True)
    _model_module_version = Unicode(module_version).tag(sync=True)

    _view_name = Unicode('GalaxyBaseWidgetView').tag(sync=True)
