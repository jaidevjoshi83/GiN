...
class GalaxyTaskWidget(GalaxyUIBuilder):
    ...
    def __init__(self, tool=None, **kwargs):
        ...
        # id_uid = tool["id"].split(':')

        # print(id_uid)

        # self.tool['id'] = id_uid[0]
        # self.tool['UID'] = id_uid[1]

        """Initialize the task widget"""

        # self.handle_error_task("No Galaxy module specified.", **kwargs)
        ...
        GalaxyUIBuilder.__init__(
            self,
            inputs=inputs,
            galaxy_tool_id=self.tool["id"].split(':')[0],
