 ...
 */
 ...
 export class GalaxyUIOutputView extends UIOutputView {
     ...
     render_error = super.render_error
     render_description = super.render_description
     render_info = super.render_info
     attach_child_widget = super.attach_child_widget
     add_menu_item = super.add_menu_item
     create_menu_callback = super.create_menu_callback
     ...
     render_files(files:string[], widget:GalaxyUIOutputView) {
         let to_return = '';
         files.forEach(path => {
             const name = extract_file_name(path);
             const type = extract_file_type(path) as string;
             const path_prefix = GalaxyUIOutputView.pick_path_prefix(path);
     ...
     render_visualization(visualization:string, widget:GalaxyUIOutputView) {
     ...
     initialize_file_menus(widget:GalaxyUIOutputView) {
